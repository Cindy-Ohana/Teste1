...
if(fome <=0 || higiene<=0 || sono<=0 || diversao<=0 || social<=0 ){
    document.getElementById("pet").src = "imagens/preto.jpg";
    document.getElementById("pet").innerHTML = "Você deixou seu pet morrer, atualize a página";
}

else if (total > 400){
 document.getElementById("pet").src = "imagens/azul.jpg";

}else if (total > 300){
document.getElementById("pet").src = "imagens/verde.jpg";


}else if (total > 200){
document.getElementById("pet").src = "imagens/cinza.jpg";


}else if (total > 100){
document.getElementById("pet").src = "imagens/amarelo.jpg";


}else if (total > 50){
document.getElementById("pet").src = "imagens/vermelho.jpg";
}
